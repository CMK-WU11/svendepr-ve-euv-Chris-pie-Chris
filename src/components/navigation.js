    ...
    return (
        <nav 
            className="sticky bottom-0 left-0 w-full bg-white flex justify-between items-center p-4 shadow-[0_-4px_4px_rgba(0,0,0,0.1)] border-t border-gray-200">
                ...
                <Link href="/Sogefelt" className="rounded-full border-black"><LuSearch className="w-12 h-6" /></Link>
                <Link href="/Kalender" className="rounded-full border-black"><LuCalendar className="w-12 h-6"/></Link>
        </nav>
    )
}